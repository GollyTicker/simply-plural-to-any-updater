...
pub fn downgrade<Secret: secrets::SecretType, C: ConstraintsType>(
    ...
    UserConfigDbEntries {
        ...
        bridge_pairing_code_expires_at: value.bridge_pairing_code_expires_at,
        ...
        bridge_pairing_code: value.bridge_pairing_code.clone(),
        bridge_secret: value.bridge_secret.clone(),
