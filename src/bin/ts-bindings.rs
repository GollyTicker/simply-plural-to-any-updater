use anyhow::Result;
use sp2any::{
    database::Decrypted, for_discord_bridge::UserLoginCredentials, license, users::{Email, JwtString, UserConfigForUser, UserProvidedPassword}
};
use specta::{
    self,
